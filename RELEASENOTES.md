...
* Updated Device, OS and user-agent list [#302](https://github.com/microsoft/cordova-simulate/pull/302), thanks to [@mfish33](https://github.com/mfish33)
* Added command to generate unique UUIDs for simulated devices with UUID4 id format [#303](https://github.com/microsoft/cordova-simulate/pull/303), thanks to [@mfish33](https://github.com/mfish33)
